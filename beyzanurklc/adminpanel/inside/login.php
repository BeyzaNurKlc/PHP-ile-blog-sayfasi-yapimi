...
<head>
  ...
  <title>Beyza Nur Kılıç'ın Yönetim Paneline Hoşgeldiniz. </title>
    ...
    <div class="login_wrapper">
      <div class="animate form login_form">
        <section class="login_content">
          ...
          <form action="../baglantim/islem.php" method="POST">
            ...
            <div class="separator">
             ...
             ?>
              ...
              <div>
                <h1><i class="fa fa-paw"></i> Bireysel Blog Sayfası</h1>
                <p>©2023 beyzanurklc</p>
              </div>
            </div>
          </form>
